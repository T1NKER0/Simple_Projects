...
// Your program can manipulate variables even if the variables have no identifiers to name them. 
// These nameless variables are referred to by pointers.
...
int main()
{
    ...
    // ***note that name points to name[0]***
       cin >> *(name + pos);
       pos++;
